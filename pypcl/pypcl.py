...
class PclDocument( list ):
	...
	def append( self, item ):
		...
		assert ((item[0] != PCL_DATA_TYPE.BINARY) and isinstance( item[1], str )) or ((item[0] == PCL_DATA_TYPE.BINARY) and isinstance( item[1], bytes )), 'tuple[1] must be an str string or binary!'
